...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    /* Contact c = Contact();
    c.name = "Leonardo Lessa";
    c.email = "lessa.leo20@gmail.com";
    c.phone = "(22)997407035";
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: contacts[index].img != null ? FileImage(File(contacts[index].img)):AssetImage('assets/default.png'),
                  )
                ),
              ),
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text(contacts[index].name??'', style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold),),
